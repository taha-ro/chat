...
if "next" in params:
    ...
    st.markdown(
        ...
        <p class="farsi-hi">سلام! 🙌 یه برنامه نویس خجالتی که اگه مایل باشید00 دوست داره باشما بیشتر آشنا بشه(ماشین برقی سفیده) اگه هم مایل نیستید ببخشید وقتتون رو گرفتم </p>
        """,
